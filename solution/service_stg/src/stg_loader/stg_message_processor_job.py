...
class StgMessageProcessor:
    ...
    def run(self) -> None:
        ...
        self._logger.info(f"{datetime.now(timezone.utc)}: START stg")
        ...
        for _ in range(self._batch_size):
            ...
            self._logger.info(f"{datetime.now(timezone.utc)}: Message received stg")
            ...
            self._logger.info(f"{datetime.now(timezone.utc)}. Message Sent stg")


        # Пишем в лог, что джоб успешно завершен.
        self._logger.info(f"{datetime.now(timezone.utc)}: FINISH stg")
